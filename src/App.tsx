...
export const App: React.FC = () => {
  ...
  const [twinVisited, setTwinVisited] = useState(window.location.hash === '#/digital-twin');
  useEffect(() => {
    const update = () => {
  ...
  return <><nav className="mode-nav" aria-label="Режим приложения">
    <a href="#" aria-current={!twin ? 'page' : undefined}>Аким на 5 часов</a>
    <a href="#/digital-twin" aria-current={twin ? 'page' : undefined}>Симулятор города</a>
